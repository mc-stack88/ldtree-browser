...
var Query = /** @class */ (function (_super) {
     ...
     * @param session -
     */
    Query.prototype.set_session = function (session) {
     ...
     * @param node
     */
    Query.prototype.emitMember = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            var members, _i, members_1, member;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, node.getMembers()];
                    case 1:
                        members = _a.sent();
     ...
     * @param node
     */
    Query.prototype.emitNode = function (node) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.emit("node", node);
                return [2 /*return*/];
